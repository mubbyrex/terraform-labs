module "vpc" {
  source = "git::https://github.com/mubbyrex/terraform-modules.git//aws/aws-vpc-core?ref=v1.0.0"
...
module "aws_instance" {
  source = "git::https://github.com/mubbyrex/terraform-modules.git//aws/aws-ec2-core?ref=v1.0.0"
